...
<body>
    ...
    <section id="mission-vision">
        ...
        <div class="container">
            <div class="card" onclick="openModal('mission')">
                <h3>Mission</h3>
                <img src="all2.jpg" alt="Mission Image">
                <p>Sharing Christ + Maturing Believers + Changing the World</p>
            </div>
            <div class="card" onclick="openModal('vision1')">
                <h3>Vision</h3>
            ...
            <div class="card" onclick="openModal('vision2')">
                ...
                <img src="pyy1.jpg" alt="Vision Image 2">
                <p>
                    We see a church where the Word of God reigns supreme. It grows and prevails against unbelief, culture, and worldly influence in the lives of people.
                </p>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        const data = {
            mission: {
                title: 'Mission',
                content: '<h3>Mission</h3><p>Sharing Christ + Maturing Believers + Changing the World</p>'
            },
            vision1: {
                title: 'Vision',
            ...
            vision2: {
                ...
                content: '<h3>Vision Details</h3><p>We see a church where the Word of God reigns supreme. It grows and prevails against unbelief, culture, and worldly influence in the lives of people. As God\'s word rises in the hearts of members, its influence is inescapable in the nation.</p>'
            }
        };

        function openModal(type) {
            modal.style.display = 'flex';
            modalData.innerHTML = data[type].content;
        }
